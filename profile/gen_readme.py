...
out.append("- 🛣️ **In design — x402 payments** — pay-per-call stablecoin settlement (USDC on Solana) so an agent's `spend_cap_usd` becomes a hard, autonomous budget · [details →](./keyshield-process.md)")
out.append("")
out.append("<sub>Stack: `TypeScript` · `Rust` · `Python` · MCP · Solana · x402</sub>")
out.append("")
out.append("---")
out.append("")
